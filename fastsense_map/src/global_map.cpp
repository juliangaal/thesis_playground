...
{
    auto chunk_size = GlobalMap::CHUNK_SIZE; // compiler bug when used directly in next line wtf
    pos -= chunkPos * chunk_size;
    return (pos.x() * GlobalMap::CHUNK_SIZE * GlobalMap::CHUNK_SIZE + pos.y() * GlobalMap::CHUNK_SIZE + pos.z());
}
