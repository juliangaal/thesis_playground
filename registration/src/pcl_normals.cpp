...
int main (void)
{
    ...
    pcl::PointCloud<pcl::PointXYZRGBA>::Ptr features_orig(new pcl::PointCloud<pcl::PointXYZRGBA>);
    float threshold = 0.1;
    calculate_features(cloud, features_orig, threshold, {255, 0, 0, 255});
    ...
    pcl::PointCloud<pcl::PointXYZRGBA>::Ptr features_trans(new pcl::PointCloud<pcl::PointXYZRGBA>);
    calculate_features(transformed_cloud, features_trans, threshold, {255, 0, 0, 255});
    
    show_cloud(viewer, {cloud, features_orig, transformed_cloud, features_trans});
